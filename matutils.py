...
'''scipy provides a mechanism to call some BLAS functions:'''
...
'''
The BLAS function nrm2 does automatic scaling of parameters rendering it more stable and
tolerant to overflow.
'''
